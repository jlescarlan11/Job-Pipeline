...
import { validateFreshSheetConfig } from "../src/fresh-sheet-setup.mjs";
...
if (review?.schema_version !== 9) {
  throw new Error("review-sheet schema_version must be 9");
}
if (
  JSON.stringify(
    Object.fromEntries(
...
const reviewErrors = validateFreshSheetConfig(review, schema);
if (reviewErrors.length > 0) {
  throw new Error(`Invalid review sheet configuration:\n- ${reviewErrors.join("\n- ")}`);
}
...
const setup = {
  ...
  recordHeaderUpgrade: review.record_header_upgrade,
