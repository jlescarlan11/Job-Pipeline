...
After the guarded 2026-08-04 production backfill, workflow contract `2026-08-04/v1` rejects every pre-SHA-256 state guard. The artifact builder and deployment policy both fail closed if legacy movement compatibility is reintroduced.
