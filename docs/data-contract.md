...
source remains available for a later reconciled run. Final copy confirmation
treats active-owned alert and processing fields as exact, including intentional
blank clears, before authorizing deletion of the active source.
